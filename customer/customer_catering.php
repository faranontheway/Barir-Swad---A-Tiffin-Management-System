...
<body>
    <header class="header">
        <div class="nav">
            ...
            <nav class="nav-links">
                ...
                <a href="../meal/catering.php">Book Catering</a>
    ...
    <div class="container">
        ...
        <div class="quick-actions">
            <a href="../meal/catering.php" class="btn btn-success">Book New Catering Service</a>
        </div>
        ...
        <div class="bookings-section">
            ...
            <?php else: ?>
                <div class="no-bookings">
                    ...
                    <a href="../meal/catering.php" class="btn btn-success" style="margin-top: 20px;">
