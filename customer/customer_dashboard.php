    ...
    <div class="container">
        <div class="welcome-section">
            ...
            <div class="quick-actions">
                <a href="../meal/meal.php" class="btn btn-primary">Browse Meals</a>
                <?php if (isset($_SESSION['cart']) && count($_SESSION['cart']) > 0): ?>
        ...
        <div class="dashboard-sections">
            <div class="section-card">
                ...
                <?php else: ?>
                    <p style="text-align: center; color: #666;">No orders yet. <a href="../meal/meal.php" style="color: #667eea;">Start by browsing our meals!</a></p>
                <?php endif; ?>
            </div>
                    ...
                    <div class="meal-grid">
                        <?php while($meal = $popular_meals->fetch_assoc()): ?>
                            <div class="meal-card">
                                ...
                                <a href="../meal/add_to_cart.php?meal_id=<?= $meal['Meal_ID'] ?>" class="btn-order">Add to Cart</a>
                            </div>
                        <?php endwhile; ?>
                    </div>
                    <div style="text-align: center; margin-top: 20px;">
                        <a href="../meal/meal.php" style="color: #667eea; text-decoration: none;">View All Meals →</a>
                    </div>
                <?php else: ?>
