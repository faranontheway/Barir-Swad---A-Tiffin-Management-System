...
if (!isset($_SESSION['cart']) || count($_SESSION['cart']) == 0) {
    ...
    echo "<p style='text-align:center;'><a href='../meal/meal.php' style='color:#D6877F; font-weight:bold;'>🍴 Back to Menu</a></p>";
    exit;
}
...
<body>
  <div class="cart-container">
    ...
    <div style="text-align:center;">
      <a href="../meal/checkout.php" class="checkout-btn">Proceed to Checkout</a>
      <a href="../meal/meal.php" class="back-btn">🍴 Back to Menu</a>
    </div>
  </div>
</body>
</html>